...
function StudentNameDisplay({Name,Class,Stream,OTP,hasVoted,highLightOtps}) {
  return (
    <div className='w-full border border-gray-400 backdrop-filter text-slate-900 dark:text-white cursor-pointer bg-white dark:bg-[#1E293B]/30 shadow-md hover:shadow-xl  transition-all duration-200 ease-out transform-gpu hover:-translate-y-0.5 hover:scale-[1.01] text-left flex justify-around items-center overflow-scroll hide-scrollbar gap-10 py-8 px-8 my-4 rounded-lg mr-4'>
