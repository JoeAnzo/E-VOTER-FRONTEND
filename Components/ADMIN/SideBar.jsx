...
function SideBar({handleGenerateOTPs,handleGenerateStaffOTPs,handleFileUpload,handleStaffFileUpload,handleFileChange,handleStudentsExport,handleStaffExport,handleStaffFileChange}) {
  ...
  console.log(path)
  return (
    <div className={`h-full dark:bg-[#1E293B] bg-white ${toggleIcon ? 'hidden':'visible'}  absolute z-30 sm:flex flex-1 flex-col pl-8 py-8 dark:text-white text-slate-900 shadow-2xl overflow-scroll hide-scrollbar  items-left`}>
        ...
        <div>
          ...
          <div className={`flex flex-col ${path === '/admin/students'? '':'hidden'}`}>
            <label htmlFor="fileUpload" className="text-center p-4 gap-2 flex hover:cursor-pointer">
            ...
            <button onClick={handleFileUpload} className="p-4 gap-2 flex hover:cursor-pointer">
              <UploadCloud/> Upload List 
            </button>
            <button onClick={handleGenerateOTPs} className="p-4 gap-2 flex hover:cursor-pointer">
              <KeyRoundIcon/> generate OTPS 
            </button>
            <button onClick={handleStudentsExport} className="p-4 gap-2 flex hover:cursor-pointer">
        ...
        <div>
          ...
          <div className={`flex flex-col ${path === '/admin/staff'? '':'hidden'}`}>
            ...
            <button onClick={handleStaffFileUpload} className="p-4 hover:cursor-pointer gap-2 flex">
              <UploadCloud/> Upload List 
            </button>
            <button onClick={handleGenerateStaffOTPs} className="p-4 gap-2 flex hover:cursor-pointer">
              <KeyRoundIcon/> generate OTPS 
            </button>
            <button onClick={handleStaffExport} className="p-4 hover:cursor-pointer gap-2 flex">
              <Download/> Export List 
            </button>
          </div>
        </div>
